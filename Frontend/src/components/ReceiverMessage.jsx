...
function ReceiverMessage({image,message}) { // passing props to the child function
  ...
  return (
    <div className='flex items-start gap-[10px]'>
        ...
        <div ref={scroll} className='w-fit max-w-[500px] bg-[#2196f3] px-[20px] py-[10px] text-white text-[19px] rounded-tl-none rounded-2xl relative left-0 mr-auto shadow-gray-400 shadow-lg gap-[10px] flex flex-col'>
